...
public static void task22() {
    ...
    String powStr[][] = {{"бакинский", "бача", "бачей"}, {"тыс€ча", "тыс€чи", "тыс€ч"}, {"миллион", "миллиона", "миллионов"}};
    String str_1_2[][] = {{"одна", "один"}, {"две", "два"}};
    String str_3_19[] = {"три", "четыре", "п€ть", "шесть", "семь", "восемь", "дев€ть", "дес€ть",
        "одинадцать", "двенадцать", "тринадцать", "четырнадцать", "п€тнадцать", "шестнадцать", "семнадцать",
        "восемнадцать", "дев€тнадцать"};
    String str_20_90[] = {"двадцать", "тридцать", "сорок", "п€тьдес€т", "шестьдес€т", "семьдес€т", "восемьдес€т", "дев€носто"};
    String str_100_900[] = {"сто", "двести", "триста", "четыреста", "п€тьсот", "шестьсот", "семьсот", "восемсот", "дев€тьсот"};

    String strNum = "";
    int padej = 2;

    int num = 11102341;  // это число "озвучиваетс€"
    int powNum;
